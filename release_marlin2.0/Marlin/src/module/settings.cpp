...
//2021-10-18 harley
  ...
  //
    ...
    uint16_t anker_an_stall_sensitivity;     
  #endif

  #if ENABLED(ANKER_PROBE_SET)
    uint16_t anker_probe_set_homing_value;
    uint16_t anker_probe_set_leveing_value;   
  #endif
...
#include "../core/debug_out.h"
  ...
  bool MarlinSettings::save() {
    ...
    //
      ...
      EEPROM_WRITE(use_z_sensorless.an_stall_value);
    #endif
    
    #if ENABLED(ANKER_PROBE_SET)
      EEPROM_WRITE(anker_probe_set.homing_value);
      EEPROM_WRITE(anker_probe_set.leveing_value);     
    #endif
  ...
  bool MarlinSettings::_load() {
    ...
    if (strncmp(version, stored_ver, 3) != 0) {
      ...
      #if HAS_MULTI_LANGUAGE
      {
        ...
        EEPROM_READ(use_z_sensorless.an_stall_value);
      #endif

      #if ENABLED(ANKER_PROBE_SET)
        EEPROM_READ(anker_probe_set.homing_value);
        EEPROM_READ(anker_probe_set.leveing_value);     
      #endif
      //
