...
void slow_line_to_current(const AxisEnum fr_axis) { _line_to_current(fr_axis, 1); }
void fast_line_to_current(const AxisEnum fr_axis) { _line_to_current(fr_axis, 1); }
