...
#define STRING_CONFIG_H_AUTHOR "(ANKER, V8110)" // Who made the changes.
...
/**
 * Select a third serial port on the board qto use for communication with the host.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ANKER_V8110_V0_4
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 61.74
  #define DEFAULT_bedKi 11.97
  #define DEFAULT_bedKd 212.38
...
#define EXTRUDE_MINTEMP 160//170
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 64, 64, 266, 1280 }//for double speed machine,E steps need to change to this 
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 128, 128, 400, 1280 }//for double speed machine,E steps need to change to this 
/**
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 250, 250, 50, 250 } // ...or, set your own edit limits
#endif
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 200, 200, 200, 200 } // ...or, set your own edit limits
  #endif
#endif
...
#define LA_V1_DEFAULT_MAX_ACCELERATION      { 6000, 6000, 100, 3500 }
#define LA_V1_MAX_ACCEL_EDIT_VALUES         { 8000, 8000, 500, 8000 }
#define LA_MAX_ACCEL_EDIT_VALUES            { 20000, 20000, 500, 8000 }
#define LA_V1_MAX_JERK_EDIT_VALUES          { 100, 100, 100, 100 }
#define LA_V1_DEFAULT_XJERK                 10.0
#define LA_V1_DEFAULT_YJERK                 10.0
#define LA_V1_DEFAULT_ZJERK                 0.5
...
#define LA_V1_DEFAULT_RETRACT_ACCELERATION  3500    // E acceleration for retracts
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0.07 }
// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 5
                    
// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE 10800//6000
...
#define ANKER_Z_PROBE_FEEDRATE_SLOW 40
...
#define Y_MAX_POS Y_BED_SIZE+12.5
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 7//7//5
...
#define HOMING_FEEDRATE_MM_M   { (35*60), (35*60), (10*60) }//{ (45*60), (40*60), (10*60) }
